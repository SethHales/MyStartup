  ...
  return (
    <main className="login-page">
      <section className="login-hero">
        <p className="login-kicker">Scriptures</p>
        <h2>Study with consistency.</h2>
        <p className="login-hint">
          {isSignup ? "Create the same account you'll use across QuickSets and Scriptures." : "Use your shared QuickSets account to pick up where you left off."}
        </p>
      </section>
